...
//
// Mirrored byte-for-byte from gym-app/lib/member-access.ts (same "ported
// pure logic" pattern already used for gramsForServing/nutritionForGrams and
// the food-submission eligibility check) so the client never shows something
